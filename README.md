...
local UICorner = Instance.new("UICorner")
local LoaderIcon = Instance.new("ImageLabel")
...
LoaderUI.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")
LoaderUI.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

Loader.Name = "Loader"
Loader.Parent = LoaderUI
Loader.BackgroundColor3 = Color3.fromRGB(12, 14, 17)
Loader.BorderColor3 = Color3.fromRGB(0, 0, 0)
Loader.BorderSizePixel = 0
Loader.Position = UDim2.new(0, 425, 0, 150)
Loader.Size = UDim2.new(0, 292, 0, 168)

UICorner.CornerRadius = UDim.new(0, 10)
UICorner.Parent = Loader

LoaderIcon.Name = "LoaderIcon"
LoaderIcon.Parent = Loader
LoaderIcon.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
LoaderIcon.BackgroundTransparency = 1.000
LoaderIcon.BorderColor3 = Color3.fromRGB(0, 0, 0)
LoaderIcon.BorderSizePixel = 0
LoaderIcon.Position = UDim2.new(0.297722191, 0, 0.0908521041, 0)
LoaderIcon.Size = UDim2.new(0, 117, 0, 77)
LoaderIcon.Image = "rbxassetid://70944899239586"
LoaderIcon.ImageColor3 = Color3.fromRGB(82, 113, 255)

UIStroke.Parent = Loader
UIStroke.Color = Color3.fromRGB(55, 77, 172)
UIStroke.Thickness = 5.000

SliderBack.Name = "SliderBack"
SliderBack.Parent = Loader
SliderBack.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
SliderBack.BackgroundTransparency = 1.000
SliderBack.BorderColor3 = Color3.fromRGB(0, 0, 0)
SliderBack.BorderSizePixel = 0
SliderBack.Position = UDim2.new(0.0324470587, 0, 0.662280679, 0)
SliderBack.Size = UDim2.new(0, 272, 0, 10)

UICorner_2.Parent = SliderBack

UIStroke_2.Parent = SliderBack
UIStroke_2.Color = Color3.fromRGB(51, 51, 51)
UIStroke_2.Thickness = 1.500

SliderDrag.Name = "SliderDrag"
SliderDrag.Parent = SliderBack
SliderDrag.BackgroundColor3 = Color3.fromRGB(82, 113, 255)
SliderDrag.BorderColor3 = Color3.fromRGB(0, 0, 0)
SliderDrag.BorderSizePixel = 0
SliderDrag.Position = UDim2.new(-4.47144004e-07, 0, 0, 0)
SliderDrag.Size = UDim2.new(0, 0, 0, 10)

UICorner_3.Parent = SliderDrag

local function GJZP_script()
	local script = Instance.new('LocalScript', Loader)

	local TweenService = game:GetService("TweenService")
	local loader = script.Parent
	local sliderback = loader:WaitForChild("SliderBack")
	local slider = sliderback:WaitForChild("SliderDrag")

	loader.Position = UDim2.new(0, 425, 0, 425)

	local initialTweenInfo = TweenInfo.new(
		1,
	...
	local goalPosition1 = UDim2.new(0, 425, 0, 150)
	local loaderTween1 = TweenService:Create(loader, initialTweenInfo, {Position = goalPosition1})
	loaderTween1:Play()

	loaderTween1.Completed:Wait()

	slider.Size = UDim2.new(0, 0, 0, 10)
	local goalSize = UDim2.new(0, 272, 0, 10)
	...
	tween.Completed:Connect(function()
		local goalPosition2 = UDim2.new(0, 425, 0, -150)
		local loaderTween2 = TweenService:Create(loader, initialTweenInfo, {Position = goalPosition2})
		loaderTween2:Play()

		loaderTween2.Completed:Connect(function()
			loader.Visible = false
		end)
	end)

end
coroutine.wrap(GJZP_script)()
